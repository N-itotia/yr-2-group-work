                    ...
                    <ul>
                        <table style="width:100%; ">
                            <tr>
                                ...
                                <td align=right>Lang'ata</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-calendar"></span> : Date</td>
                                <td align=right>12th July, 2018</td>
                            </tr>
                            <tr>
                        ...
                        <table style="width:100%; ">
                            <tr>
                                <td><span class="glyphicon glyphicon-map-marker"></span> : Venue</td>
                                <td align=right>Nairobi West</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-calendar"></span> : Date</td>
                        ...
                        <table style="width:100%; ">
                            <tr>
                                <td><span class="glyphicon glyphicon-map-marker"></span> : Venue</td>
                                <td align=right>West Madaraka</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-calendar"></span> : Date</td>
            ...
            <div class="frontBlood">
                ...
                <div class="frontContent">
                    <ul>
                        <table style="width:100%; ">
                            <tr>
                                <td><span class="glyphicon glyphicon-map-marker"></span> : Nairobi</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-user"></span> : Johnney</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-earphone"></span> : +254 705109561</td>
                            </tr>
                        </table>
                        <hr>
                        ...
                        <table style="width:100%; ">
                            <tr>
                                <td><span class="glyphicon glyphicon-map-marker"></span> : Mombasa</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-user"></span> : Nigel</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-earphone"></span> : +254 701038353</td>
                            </tr>
                        </table>
                        <hr>
                        ...
                        <table style="width:100%; ">
                            <tr>
                                <td><span class="glyphicon glyphicon-map-marker"></span> : Kisumu</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-user"></span> : Akatsuki</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-earphone"></span> : +254 723447064</td>
                            </tr>
                        </table>
                        <hr>
                        ...
                        <table style="width:100%; ">
                            <tr>
                                <td><span class="glyphicon glyphicon-map-marker"></span> : Nakuru</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-user"></span> : Waldo</td>
                            </tr>
                            <tr>
                                <td><span class="glyphicon glyphicon-earphone"></span> : +254 729414450</td>
                            </tr>
                        </table>
                        <hr>
